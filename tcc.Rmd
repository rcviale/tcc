...
The next section describes the results from these Fama-MacBeth regressions, mainly focusing on the $\lambda_2$ coefficients' significance, responsible for the effect of the crypto market volatility betas on individual asset returns.
